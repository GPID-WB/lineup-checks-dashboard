...
output:
  flexdashboard::flex_dashboard:
    ...
    runtime: shiny
resource_files:
- data/aggregates/pip_new.fst
- data/aggregates/pip_old.fst
- data/lyears/pip_new.fst
- data/lyears/pip_old.fst
- data/syears/pip_new.fst
- data/syears/pip_old.fst
---
...
-----------------------------------------------------------------------
```{r sidebar-plot-trends}
# Select Indicator
selectInput("trends_indicator", 
            label = "Compare indicator (surveys)",
            choices = survey_indicators,
            selected = "mean")

# # Select Indicator
# selectInput("trends_indicator", 
#             label = "Compare indicator (lineup)",
#             choices = lineup_indicators,
#             selected = "mean")

# Select countries
selectInput("trend_country",
            label = "Economies (survey)",
...
# # Select countries
# selectInput("trend_country", 
#             label = "Economies (lineup)",
#             choices = c(lineups_merged$country_code |> funique()),
#             selected = "COL", 
#             multiple = FALSE)
```
