...
```{r}
# aggregates
dt_agg_old <- fst::read_fst(path = here::here("data", "aggregates", "pip_old.fst"))
dt_agg_new <- fst::read_fst(path = here::here("data", "aggregates", "pip_new.fst"))

# aggregates
dt_survey_old <- fst::read_fst(path = here::here("data", "syears", "pip_old.fst"))
dt_survey_new <- fst::read_fst(path = here::here("data", "syears", "pip_new.fst"))

# aggregates
dt_lineup_old <- fst::read_fst(path = here::here("data", "lyears", "pip_old.fst"))
dt_lineup_new <- fst::read_fst(path = here::here("data", "lyears", "pip_new.fst"))
